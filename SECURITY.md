...
Replace this section with the supported versions for `portpatrol`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `portpatrol` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in portpatrol.
